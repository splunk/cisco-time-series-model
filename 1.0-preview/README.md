# Cisco Time Series Model - 1.0 Preview
...
The technical report is now available on [arXiv](https://arxiv.org/abs/2511.19841); you can also access a local copy [here](technical_report/Cisco-Time-Series-Model-Technical-Report.pdf).

### Example Visualization of Multiresolution Time Series Input to the Model
<figure>
  <img src="../1.0/images/multi_resolution_time_series_example.png" alt="Multiresolution time series example with padded 1-hour context">
...
- [CPU Utilization Forecasting](notebooks/cpu_utilization_forecast.ipynb)
- [Alerting Server Response Time Forecasting](notebooks/alerting_server_responsetime.ipynb)
- [Internet Traffic Forecasting](notebooks/internet_traffic_forecast.ipynb)
